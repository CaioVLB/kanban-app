<x-modal name="confirm-action-modal" :show="false" maxWidth="sm">
  <!-- Modal content -->
  <div class="relative bg-white dark:bg-gray-700" x-data>
    ...
    <header class="flex items-center justify-between px-4 py-3 border-b dark:border-gray-600">
      <h3 class="text-lg font-semibold truncate text-gray-900 dark:text-white">Confirmar Ação</h3>
    ...
    <div class="flex flex-col justify-center items-center px-6 py-4">
      ...
      <p class="text-justify dark:text-white">
        <b>Atenção:</b> Tem certeza de que deseja sair da avaliação? Se foram feitas modificações, elas não serão salvas.
      </p>
    </div>
    <!-- Modal footer -->
    <footer class="flex justify-center items-center px-4 pb-4">
      @include('evaluations.forms.confirm-action-form')
    </footer>
  </div>
</x-modal>
