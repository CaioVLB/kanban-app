    ...
    <ul>
      ...
      <li class="relative group" x-data="{ openTeam : false }">
        ...
        <ul x-show="openTeam" x-cloak x-transition class="pl-6 mt-1 space-y-1">
          ...
          <li>
            <a href="{{ route('role') }}" class="flex items-center p-2 text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white hover:bg-gray-100 dark:hover:bg-gray-700 rounded-md transition duration-150 ease-in-out">
              Cargos
            </a>
          </li>
        </ul>
