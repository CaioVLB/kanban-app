    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6 gap-2" x-data>
                <x-button-modal onclick="$dispatch('open-modal', 'help-modal');" :title="'Suporte'" class="px-2">
                  <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="#000000" viewBox="0 0 256 256" class="h-7 w-7 fill-gray-500 dark:fill-white">
