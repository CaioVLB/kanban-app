<form :action="'{{ route('client.files.destroy', '') }}' + '/' + fileId" method="POST" @submit.prevent="isLoadingFileDeletion = true; $el.submit()" class="flex items-center justify-center col-span-1">
  @csrf
  @method('DELETE')
  <button type="submit"
