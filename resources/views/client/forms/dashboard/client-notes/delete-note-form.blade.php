<form :action="'{{ route('client.destroyNotes', '') }}' + '/' + noteId" method="POST" @submit.prevent="isLoadingNoteDeletion = true; $el.submit()" class="flex items-center justify-center col-span-1">
  @csrf
  @method('DELETE')
  <button type="submit"
