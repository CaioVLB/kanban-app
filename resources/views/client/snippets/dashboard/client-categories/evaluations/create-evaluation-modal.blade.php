<x-modal name="evaluation-create-modal" :show="false" maxWidth="lg">
  <!-- Modal content -->
  <div class="relative bg-white dark:bg-gray-700" x-data>
    <!-- Modal header -->
    <div class="flex items-center justify-end px-4 pt-3 dark:border-gray-600">
    ...
    <!-- Modal body -->
    @include('client.forms.dashboard.client-categories.create-evaluation-form')
  </div>
</x-modal>
