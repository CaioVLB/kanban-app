<div x-data="client_files()" class="w-full flex flex-col items-start bg-white shadow rounded-lg p-4 dark:bg-gray-800">
  <div class="w-full flex justify-between">
    <div class="flex items-center">
      ...
      <h2 class="text-xl font-bold text-gray-900 dark:text-white">Arquivos Gerais</h2>
    </div>
    @if(count($files) > 0)
      <div class="flex items-center">
    ...
    @empty
      <div class="w-full md:flex">
        ...
        <div class="p-3 mx-0 mt-2">
          <p class="py-1 px-1 mb-6 text-start text-gray-600 dark:text-gray-100">Até o momento, este paciente não possui
