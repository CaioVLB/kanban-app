<div x-data="client_files()" class="w-full flex flex-col items-start bg-white shadow rounded-lg p-4 dark:bg-gray-800">
  ...
  <div class="md:flex">
    <div class="w-full">
      <img src="{{ asset("images/vetores/upload-file.png")}}" data-retina="true" alt="Imagem que retrata uma mulher subindo arquivos para o sistema" class="max-w-full h-[200px] mx-auto opacity-60">
    </div>
