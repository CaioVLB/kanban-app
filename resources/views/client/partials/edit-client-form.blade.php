<div class="flex-grow grid grid-cols-6 gap-4 mb-6">
    ...
    <div class="col-span-3">
        <label for="profissao" class="block mb-2 text-sm font-medium text-gray-700 dark:text-gray-300">Profissão</label>
        <input type="text" id="profissao" name="profissao" autocomplete="profissao" class="w-full border border-gray-300 text-gray-900 text-sm rounded-lg shadow-sm focus:ring-amber-400 focus:border-amber-200 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-amber-400 dark:focus:border-amber-800" placeholder="Digite o email" required>
    </div>
    <div class="col-span-3" x-data>
