            ...
            <div class="col-span-4 flex flex-col gap-y-4">
                <div class="md:flex">
                    <ul class="flex-column space-y space-y-4 text-sm font-medium text-gray-500 dark:text-gray-400 md:me-4 mb-4 md:mb-0">
                        <li>
                            <a href="#" class="inline-flex items-center px-4 py-3 w-full font-bold shadow text-amber-600 focus:outline-none bg-amber-200 rounded-lg border border-amber-300 hover:bg-amber-300 hover:text-amber-700 focus:z-10 focus:ring-4 focus:ring-gray-100 dark:focus:ring-gray-700 dark:bg-amber-600 dark:text-amber-200 dark:border-amber-700 dark:hover:text-white dark:hover:bg-amber-700 active" aria-current="page">
                                <svg class="w-5 h-5 me-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-book-user">
                        ...
                        <li>
                            <a href="#" class="inline-flex items-center px-4 py-3 bg-white border border-gray-200 rounded-lg shadow hover:text-gray-900 hover:bg-gray-100 w-full dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700 dark:hover:text-white">
                                <svg class="w-5 h-5 me-2 text-gray-500 dark:text-gray-400" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="size-6">
                    ...
                    <div class="w-full bg-white shadow text-medium text-gray-500 rounded-lg p-6 dark:text-gray-400 dark:bg-gray-800">
                        <div class="flex flex-col h-full">
                            <div>
                                <h3 class="text-lg font-bold text-gray-900 dark:text-white mb-4">Ficha do Cliente</h3>
                            </div>
                            @include('client.partials.edit-client-form')
                            <div class="flex justify-center items-center mt-auto">
                                <button class="inline-flex items-center py-2.5 px-5 text-sm font-bold text-amber-600 focus:outline-none bg-amber-200 rounded-lg border border-amber-300 hover:bg-amber-300 hover:text-amber-700 focus:z-10 focus:ring-4 focus:ring-gray-100 dark:focus:ring-gray-700 dark:bg-amber-600 dark:text-amber-200 dark:border-amber-700 dark:hover:text-white dark:hover:bg-amber-700">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="me-1 w-5 h-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-user-round-pen"><path d="M2 21a8 8 0 0 1 10.821-7.487"/><path d="M21.378 16.626a1 1 0 0 0-3.004-3.004l-4.01 4.012a2 2 0 0 0-.506.854l-.837 2.87a.5.5 0 0 0 .62.62l2.87-.837a2 2 0 0 0 .854-.506z"/><circle cx="10" cy="8" r="5"/></svg>
                            ...
                            <div class="p-3 mx-0 mt-2">
                                ...
                                <div class="flex justify-center items-center">
                                    <label for="file-upload" class="inline-flex items-center py-2.5 px-5 text-sm font-bold text-amber-600 focus:outline-none bg-amber-200 rounded-lg border border-amber-300 hover:bg-amber-300 hover:text-amber-700 focus:z-10 focus:ring-4 focus:ring-gray-100 dark:focus:ring-gray-700 dark:bg-amber-600 dark:text-amber-200 dark:border-amber-700 dark:hover:text-white dark:hover:bg-amber-700 cursor-pointer">
                                        <svg class="w-5 h-5 me-1" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="size-6">
...
{{--            <h2 class="text-xl font-semibold text-gray-900 dark:text-gray-200 mb-4">Observações do Cliente</h2>--}}

{{--            <div class="mb-4">--}}
{{--                <label for="newObservation" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Adicionar Observação</label>--}}
{{--                <textarea x-model="newObservation" id="newObservation" rows="3" class="mt-1 block w-full p-2.5 border border-gray-300 rounded-md shadow-sm focus:ring-purple-500 focus:border-purple-500 sm:text-sm dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-purple-500 dark:focus:border-purple-500"></textarea>--}}
{{--                <button @click="addObservation" class="mt-2 px-4 py-2 bg-purple-600 text-white font-semibold rounded-md hover:bg-purple-700 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-opacity-50">--}}
{{--                    Adicionar--}}
{{--                </button>--}}
{{--            </div>--}}

{{--            <div>--}}
{{--                <h3 class="text-lg font-medium text-gray-900 dark:text-gray-200">Observações</h3>--}}
{{--                <ul>--}}
{{--                    <template x-for="observation in observations" :key="observation">--}}
{{--                        <li class="mt-2 p-3 bg-gray-100 dark:bg-gray-700 rounded-md">--}}
{{--                            <p class="text-sm text-gray-700 dark:text-gray-300" x-text="observation"></p>--}}
{{--                        </li>--}}
{{--                    </template>--}}
{{--                </ul>--}}
{{--            </div>--}}
...
{{--                    this.observations.push(this.newObservation.trim());--}}
{{--                    this.newObservation = '';--}}
{{--                }--}}
{{--            }--}}
{{--        </script>--}}
