<x-app-layout>
  <div class="py-12">
    <div x-data="client()" class="flex flex-wrap justify-start max-w-7xl mx-auto px-4 md:px-2">
        ...
        <div class="w-full flex justify-center items-center border border-gray-200 rounded-lg shadow bg-white p-4 mx-2 mb-2 hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
          ...
          <div class="w-full grid grid-cols-3 gap-4 sm:grid-cols-2 lg:grid-cols-4 py-2 px-4">
            <div class="flex flex-col">
              ...
              <span class="text-start text-gray-900 font-bold dark:text-white" :title="client.name" x-text="client.name"></span>
            </div>
            <div class="flex flex-col">
              <label class="text-start text-gray-600 dark:text-gray-400">Telefone</label>
              <span class="text-start text-gray-900 font-bold dark:text-white" :title="client.phone" x-text="client.phone"></span>
            </div>
            <div class="flex flex-col">
              <label class="text-start text-gray-600 dark:text-gray-400">Email</label>
              <span class="text-start text-gray-900 font-bold dark:text-white" :title="client.email" x-text="client.email"></span>
            </div>
          </div>
