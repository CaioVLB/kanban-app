<form :action="routes.delete" method="POST" @submit.prevent="isLoadingEvolutionDeletion = true; $el.submit()">
  @csrf
  @method('DELETE')
  <button type="submit"
          x-bind:disabled="isLoadingEvolutionDeletion"
          ...
          <span x-show="isLoadingEvolutionDeletion" x-transition>
    ...
    <span x-show="!isLoadingEvolutionDeletion">Confirmar</span>
  </button>
</form>
