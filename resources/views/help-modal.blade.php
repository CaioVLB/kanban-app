<x-modal name="help-modal" :show="false" maxWidth="sm">
  ...
  <div class="relative bg-white dark:bg-gray-700" x-data>
    ...
    <header class="flex items-center justify-between px-4 py-3 border-b dark:border-gray-600">
      <h3 class="text-lg font-semibold truncate text-gray-900 dark:text-white">Você está precisando de ajuda?</h3>
    ...
    <div class="flex flex-col justify-center items-center px-6 py-4">
      ...
      <p class="text-justify dark:text-white">
        <b>Precisa de ajuda?</b> Ao clicar no botão abaixo, você será redirecionado para o WhatsApp, onde nossa equipe de suporte estará pronta para atender você e esclarecer suas dúvidas.
      </p>
    </div>
    <!-- Modal footer -->
    <footer class="flex justify-center items-center px-4 pb-4">
      <button @click="window.open('https://wa.me/5569992891391?text=Olá%2C%20eu%20gostaria%20de%20tirar%20uma%20dúvida!', '_blank')" class="inline-flex items-center py-2.5 px-5 gap-2 focus:outline-none bg-green-200 rounded-lg border border-green-300 hover:bg-green-300 dark:bg-green-600 dark:border-green-700 dark:hover:bg-green-700">
        <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="#000000" viewBox="0 0 256 256" class="h-5 w-5 fill-green-500">
          <path d="M187.58,144.84l-32-16a8,8,0,0,0-8,.5l-14.69,9.8a40.55,40.55,0,0,1-16-16l9.8-14.69a8,8,0,0,0,.5-8l-16-32A8,8,0,0,0,104,64a40,40,0,0,0-40,40,88.1,88.1,0,0,0,88,88,40,40,0,0,0,40-40A8,8,0,0,0,187.58,144.84ZM152,176a72.08,72.08,0,0,1-72-72A24,24,0,0,1,99.29,80.46l11.48,23L101,118a8,8,0,0,0-.73,7.51,56.47,56.47,0,0,0,30.15,30.15A8,8,0,0,0,138,155l14.61-9.74,23,11.48A24,24,0,0,1,152,176ZM128,24A104,104,0,0,0,36.18,176.88L24.83,210.93a16,16,0,0,0,20.24,20.24l34.05-11.35A104,104,0,1,0,128,24Zm0,192a87.87,87.87,0,0,1-44.06-11.81,8,8,0,0,0-6.54-.67L40,216,52.47,178.6a8,8,0,0,0-.66-6.54A88,88,0,1,1,128,216Z"></path>
        </svg>
        <span class="text-sm font-bold text-green-600 hover:text-green-700 dark:text-green-200 dark:hover:text-white">
          Chamar no WhatsApp
        </span>
      </button>
    </footer>
