<x-modal name="delete-service-modal" :show="false" maxWidth="sm">
  <!-- Modal content -->
  <div class="relative bg-white dark:bg-gray-700" x-data>
    ...
    <div class="flex flex-col justify-center items-center px-6 py-4">
      ...
      <p class="text-justify dark:text-white"><b>Atenção:</b> Tem certeza de que deseja excluir este serviço? Essa ação não poderá ser desfeita.</p>
    </div>
    <!-- Modal footer -->
    <footer class="flex justify-center items-center px-4 pb-4">
      @include('service.forms.delete-service-form')
    </footer>
  </div>
</x-modal>
