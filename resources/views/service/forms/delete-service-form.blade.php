<form :action="routes.delete" method="POST" @submit.prevent="isLoadingServiceDeletion = true; $el.submit()">
  @csrf
  @method('DELETE')
  <button type="submit"
          x-bind:disabled="isLoadingServiceDeletion"
          ...
          <span x-show="isLoadingServiceDeletion" x-transition>
    ...
    <span x-show="!isLoadingServiceDeletion">Confirmar</span>
  </button>
</form>
