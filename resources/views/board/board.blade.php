            ...
            <div class="relative flex flex-grow gap-2">
                <ol class="absolute flex flex-row overflow-x-auto overflow-y-hidden list-none select-none whitespace-nowrap p-2 mb-2 inset-0">
                    <li class="block shrink-0 p-2 h-full xl:w-[20%] lg:w-[33.3333%] md:w-[33.3333%] whitespace-nowrap">
                        <section class="max-h-full relative flex flex-col justify-between align-top box-border bg-gray-300 rounded-lg shadow whitespace-normal pb-2 dark:bg-gray-700">
                            ...
                            <ol class="flex flex-col overflow-x-hidden overflow-y-auto list-none gap-y-1 mx-[2px] px-1"> 
                                <li>
                                    <div class="min-h-9 rounded-lg bg-white border border-gray-400 shadow cursor-pointer p-2 hover:bg-gray-100 hover:border-2 dark:bg-white/25 dark:border-gray-400 dark:hover:bg-white/50">
                                        <span class="max-h-[80px] inline-block overflow-y-auto overflow-scroll overflow-x-hidden scroll-smooth break-words text-sm font-medium mb-1 px-1">
                                            Objetivo: construir um sistema de gerenciamento de prejetos que possibite uma empresa organizar a etapa onde o seu cliente está. Desta forma facilitando o acompanhamento deste.
                                        </span>
                            ...
                            <footer x-data="{ addCard: false }" class="pt-3 px-2 pb-1">
                                ...
                                <div class="w-full bg-black/25 border-gray-600 rounded-lg shadow p-4" :class=" addCard ? 'block' : 'hidden'">
                                    <form method="POST">
                                        @csrf
                                        <input type="text" name="card-name" id="card-name" autocomplete="off" aria-label="campo para nomear o cartão" class="border border-gray-300 text-gray-900 text-sm rounded shadow-sm focus:ring-amber-400 focus:border-amber-200 w-full p-2.5 dark:bg-gray-700 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-amber-400 dark:focus:border-amber-800" placeholder="Digite o nome do cartão..." required>
                                        <div class="flex items-center mt-2 gap-2">
                                            ...
                                            <button @click="addCard = !addCard" type="submit" class="w-full bg-white/25 border-gray-300 font-semibold rounded-lg shadow gap-2 py-1.5 px-2 focus:outline-none hover:bg-white/75 dark:text-white dark:bg-gray-700 dark:hover:bg-white/25 dark:border-gray-700">Cancelar</button>
                                        </div>
                                    </form>
                                </div>
                            </footer>
                    ...
                    <div x-data="{ addStage: false }" class="block shrink-0 p-2 h-full xl:w-[20%] lg:w-[33.3333%] md:w-[33.3333%] whitespace-nowrap">
                        ...
                        <div class="w-full bg-gray-300 border-gray-600 rounded-lg shadow p-4 dark:bg-gray-700" :class=" addStage ? 'block' : 'hidden'">
                            <form method="POST">
                                ...
                                <div class="flex items-center mt-2 gap-2">
                                    <button type="submit" class="w-full bg-amber-200 border-amber-300 font-semibold text-amber-600 hover:bg-amber-300 hover:border-gray-300 hover:text-amber-700 rounded-lg shadow gap-2 py-1.5 px-2 focus:outline-none dark:bg-amber-600 dark:text-amber-200 dark:hover:text-white dark:border-amber-700 dark:hover:bg-amber-700">Criar etapa</button>
                                    <button @click="addStage = !addStage" type="submit" class="w-full bg-white/25 border-gray-300 font-semibold rounded-lg shadow gap-2 py-1.5 px-2 focus:outline-none hover:bg-white/75 dark:text-white dark:bg-gray-700 dark:hover:bg-white/25 dark:border-gray-700">Cancelar</button>
                                </div>
                            </form>
                        </div>
                    </div>
