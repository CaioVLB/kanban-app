<div class="lg:col-span-1 col-span-full bg-white dark:bg-gray-800 shadow rounded-lg p-4 flex flex-col items-start">
  ...
  <div x-data="collaborator_notes()" class="mt-2 w-full">
    <form action="{{ route('collaborator.storeNotes', $collaborator->id) }}" method="POST" @submit.prevent="isLoadingNoteAdd = true; $el.submit()">
      @csrf
      <div class="flex">
    ...
    @include('collaborator.snippets.dashboard.collaborator-notes.delete-note-modal')
  </div>
</div>
