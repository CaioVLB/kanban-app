    ...
    <div class="max-w-7xl grid grid-cols-1 xl:grid-cols-6 lg:grid-cols-6 md:grid-cols-1 mx-auto lg:gap-4 gap-y-4 px-4">
        ...
        <div class="md:flex">
          <ul class="flex-column space-y space-y-4 text-sm font-medium text-gray-500 dark:text-gray-400 md:me-4 mb-4 md:mb-0">
            <li>
              <a href="#" class="inline-flex items-center px-4 py-3 w-full font-bold shadow text-amber-600 focus:outline-none bg-amber-200 rounded-lg border border-amber-300 hover:bg-amber-300 hover:text-amber-700 focus:z-10 focus:ring-4 focus:ring-gray-100 dark:focus:ring-gray-700 dark:bg-amber-600 dark:text-amber-200 dark:border-amber-700 dark:hover:text-white dark:hover:bg-amber-700 active" aria-current="page">
                <svg class="w-5 h-5 me-2 lucide lucide-book-user" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
            ...
            <li>
              <a href="#" class="inline-flex items-center px-4 py-3 bg-white border border-gray-200 rounded-lg shadow hover:text-gray-900 hover:bg-gray-100 w-full dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700 dark:hover:text-white">
                <svg class="w-5 h-5 me-2 text-gray-500 dark:text-gray-400" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
          ...
          <div class="w-full bg-white shadow text-medium text-gray-500 rounded-lg p-6 dark:text-gray-400 dark:bg-gray-800">
            <div class="flex flex-col h-full">
              <div>
                <h3 class="text-lg font-bold text-gray-900 dark:text-white mb-4">Ficha do Colaborador</h3>
              </div>
              @include('collaborator.partials.ficha-collaborator-form')
              <div class="flex justify-center items-center mt-auto">
                <button class="inline-flex items-center py-2.5 px-5 text-sm font-bold text-amber-600 focus:outline-none bg-amber-200 rounded-lg border border-amber-300 hover:bg-amber-300 hover:text-amber-700 focus:z-10 focus:ring-4 focus:ring-gray-100 dark:focus:ring-gray-700 dark:bg-amber-600 dark:text-amber-200 dark:border-amber-700 dark:hover:text-white dark:hover:bg-amber-700">
                  <svg xmlns="http://www.w3.org/2000/svg" class="me-1 w-5 h-5 lucide lucide-user-round-pen" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M2 21a8 8 0 0 1 10.821-7.487"/><path d="M21.378 16.626a1 1 0 0 0-3.004-3.004l-4.01 4.012a2 2 0 0 0-.506.854l-.837 2.87a.5.5 0 0 0 .62.62l2.87-.837a2 2 0 0 0 .854-.506z"/><circle cx="10" cy="8" r="5"/></svg>
      ...
      <div class="col-span-6">
        <div class="grid grid-cols-3 gap-x-3 gap-y-4">
          <div x-data="{ insertedFiles: [] }" class="lg:col-span-2 col-span-full flex flex-col items-start  bg-white shadow rounded-lg p-4 dark:bg-gray-800">
            ...
            <template x-if="insertedFiles.length === 0">
              <div class="md:flex">
                ...
                <div class="p-3 mx-0 mt-2">
                  <p class="py-1 px-1 mb-6 text-start text-gray-600 dark:text-gray-100">Até o momento, este colaborador não possui arquivos carregados. Sinta-se à vontade para adicionar quando necessário.</p>
          ...
          <div class="lg:col-span-1 col-span-full bg-white dark:bg-gray-800 shadow rounded-lg p-4 flex flex-col items-start">
            ...
            <div class="mt-2 w-full">
              <form method="POST">
                @csrf
                <div class="flex">
                  <input type="text" name="annotation-collaborator" id="annotation-collaborator" autocomplete="off" class="border border-gray-300 text-gray-900 text-sm rounded-s-md shadow-sm focus:ring-amber-400 focus:border-amber-200 w-full p-2.5 dark:bg-gray-700 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-amber-400 dark:focus:border-amber-800" placeholder="Escreva anotações sobre o seu colaborador" required>
              ...
              <div class="flex flex-col max-h-[460px] max-h-[460px]:overflow-scroll scroll-smooth overflow-x-hidden gap-y-0.5 mt-2">
                <form>
                  ...
                  <div class="w-full box-border h-[90px] flex justify-between py-2 px-2 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
                    <span class="w-full max-h-auto max-h-auto:overflow-scroll overflow-x-hidden scroll-smooth inline-block break-words font-bold dark:text-white">Colaborador responsável pelo gerenciamento dos clientes</span>
