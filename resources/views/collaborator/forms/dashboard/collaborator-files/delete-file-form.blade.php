<form :action="'{{ route('collaborator.files.destroy', '') }}' + '/' + fileId" method="POST" @submit.prevent="isLoadingFileDeletion = true; $el.submit()" class="flex items-center justify-center col-span-1">
  @csrf
  @method('DELETE')
  <button type="submit"
          x-bind:disabled="isLoadingFileDeletion"
        ...
        <span x-show="isLoadingFileDeletion" x-transition>
    ...
    <span x-show="!isLoadingFileDeletion">Confirmar</span>
  </button>
</form>
