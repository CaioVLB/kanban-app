<form class="p-4 md:p-5" method="POST" action="{{ route('collaborator.files.store', $collaborator->id) }}" enctype="multipart/form-data" @submit.prevent="isUploadingFile = true; $el.submit()">
  @csrf
