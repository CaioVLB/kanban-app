<form :action="'{{ route('collaborator.destroyNotes', '') }}' + '/' + noteId" method="POST" @submit.prevent="isLoadingNoteDeletion = true; $el.submit()" class="flex items-center justify-center col-span-1">
  @csrf
  @method('DELETE')
  <button type="submit"
          x-bind:disabled="isLoadingNoteDeletion"
        ...
        <span x-show="isLoadingNoteDeletion" x-transition>
    ...
    <span x-show="!isLoadingNoteDeletion">Confirmar</span>
  </button>
</form>
