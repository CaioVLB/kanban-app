<form :action="'{{ route('collaborator.addresses.destroy', '') }}' + '/' + addressId" method="POST" @submit.prevent="isLoadingDeletion = true; $el.submit()" class="flex items-center justify-center col-span-1">
  @csrf
  @method('DELETE')
  <button type="submit"
    ...
    <span x-show="!isLoadingDeletion">Confirmar</span>
  </button>
</form>
