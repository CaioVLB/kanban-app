<form x-data="{ isLoading: false }" action="{{ route('collaborator.addresses.store', $collaborator->id) }}" method="POST" @submit.prevent="isLoading = true; $el.submit()">
  @csrf
  <div class="grid grid-cols-12 gap-y-4">
    ...
    <div class="col-span-full md:col-span-5 lg:col-span-3 md:mr-2 lg:mx-2">
    ...
    <div class="col-span-full md:col-span-5 lg:col-span-4 md:mx-2">
