<form :action="'{{ route('collaborator.phones.destroy', '') }}' + '/' + phoneId" method="POST" @submit.prevent="isLoadingDeletion = true; $el.submit()" class="flex items-center justify-center col-span-1">
  @csrf
  @method('DELETE')
  <button type="submit"
