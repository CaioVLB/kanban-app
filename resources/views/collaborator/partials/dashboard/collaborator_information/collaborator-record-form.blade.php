<form>
  <div class="flex-grow grid grid-cols-6 gap-y-4 mb-6">
    <div class="col-span-full md:col-span-3 md:mr-2">
      ...
      <input type="text" id="name" name="name" autocomplete="name" class="w-full border border-gray-300 text-gray-900 text-sm rounded-lg shadow-sm focus:ring-amber-400 focus:border-amber-200 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-amber-400 dark:focus:border-amber-800" placeholder="Nome do colaborador" required>
    </div>
    <div class="col-span-full md:col-span-3 md:ml-2">
      <label for="social-name" class="block mb-2 text-sm font-medium text-gray-700 dark:text-gray-300">Nome Social</label>
      <input type="text" id="social-name" name="social-name" autocomplete="off" class="w-full border border-gray-300 text-gray-900 text-sm rounded-lg shadow-sm focus:ring-amber-400 focus:border-amber-200 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-amber-400 dark:focus:border-amber-800" placeholder="Nome social (opcional)">
    </div>
    ...
    <div class="col-span-full md:col-span-3 md:mr-2">
      <label for="date-hire" class="block mb-2 text-sm font-medium text-gray-700 dark:text-gray-300">Data de Contratação</label>
      <input type="date" id="date-hire" name="date-hire" autocomplete="off" class="w-full border border-gray-300 text-gray-900 text-sm rounded-lg shadow-sm focus:ring-amber-400 focus:border-amber-200 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-amber-400 dark:focus:border-amber-800" required>
    </div>
    <div class="col-span-full md:col-span-3 md:ml-2">
      <label for="role" class="block mb-2 text-sm font-medium text-gray-700 dark:text-gray-300">Cargo</label>
      <input type="text" id="role" name="role" autocomplete="off" class="w-full border border-gray-300 text-gray-900 text-sm rounded-lg shadow-sm focus:ring-amber-400 focus:border-amber-200 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-amber-400 dark:focus:border-amber-800" required>
    </div>
    <div class="col-span-full md:col-span-3 md:mr-2">
